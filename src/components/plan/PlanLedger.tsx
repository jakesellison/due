...
const makeStyles = (C: Tokens) =>
  StyleSheet.create({
    ...
    weekSelectorMeta: { ...statValueText(C, 'metadata', 'system'), marginTop: 3, color: C.mute, fontWeight: '700' },
    ...
    metricValue: { color: C.ink, fontFamily: data, fontSize: 19, lineHeight: 29, fontVariant: ['tabular-nums'] },
    metricValuePrimary: { fontSize: 22 },
    metricValueQuality: { color: C.qualText },
    metricValueLong: { color: C.cyanText },
    metricValueAccessible: { fontSize: 19 },
    ...
    focusLabel: { width: 84, color: C.mute, fontSize: fontSizes.metadata, lineHeight: 17, fontWeight: '600' },
