...
const makeStyles = (C: Tokens) =>
  StyleSheet.create({
    ...
    mileageSideNumber: { color: C.ink, fontSize: 20, fontWeight: '800', letterSpacing: -0.4, fontVariant: ['tabular-nums'] },
    ...
    mileageValue: { color: C.ink, fontFamily: display, fontSize: 34, lineHeight: 38, letterSpacing: -1.1, fontVariant: ['tabular-nums'] },
