...
const makeStyles = (C: Tokens) => StyleSheet.create({
  ...
  routeName: { color: C.ink, fontSize: fontSizes.sectionTitle, lineHeight: 23, fontWeight: '700' },
  ...
  stateTitle: { color: C.ink, fontSize: fontSizes.cardTitle, fontWeight: '800', textAlign: 'center' },
