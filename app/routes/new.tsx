...
const makeStyles = (C: Tokens) =>
  StyleSheet.create({
    ...
    snapFailureText: { color: C.mute, fontSize: fontSizes.metadata, lineHeight: 16, fontWeight: '600', textAlign: 'center' },
    ...
    fitLabel: { ...statValueText(C, 'labelLg', 'system'), color: C.warningText, fontWeight: '800', marginTop: space.nudge },
    ...
    finishControl: { minHeight: 44, flexDirection: 'row', padding: space.nudge, borderRadius: radius.sm, backgroundColor: C.recess, borderWidth: StyleSheet.hairlineWidth, borderColor: C.line },
    ...
    contextError: { color: C.dangerText, fontSize: fontSizes.metadata, lineHeight: 16, fontWeight: '600', textAlign: 'center' },
